...
static const int64_t MAX_MONEY = 60000000 * COIN; // 60 Million
...
/** PoW Swap mine reward */
static const int64_t SWAP_MINED_REWARD = 8000000 * COIN; // 8 Million mined for swap
/** Protocol toggle */
