...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    if(pindexBest->nTime <= 1493596800)
        obj.push_back(Pair("stakeinterest",    (uint64_t)COIN_YEAR_REWARD1));
    if(pindexBest->nTime > 1493596800)
        obj.push_back(Pair("stakeinterest",    (uint64_t)COIN_MONTH_REWARD1));
    if(pindexBest->nTime > 1586736000) // Mon, 13 Apr 2020 00:00:00 GMT
        obj.push_back(Pair("stakeinterest",    (uint64_t)COIN_MONTH_REWARD2));
    if(pindexBest->nTime > 1586736000) // Mon, 13 Apr 2020 00:00:00 GMT
        obj.push_back(Pair("stakeinterest",    (uint64_t)COIN_MONTH_REWARD3));
